...
I18N = {
    "zh": {
        ...
        "funding_blocked_banner": "⚠️ 资金不足，已提醒；资金到账后将在窗口内自动重试: {reason}",
    ...
    "en": {
        ...
        "funding_blocked_banner": "⚠️ Funding blocked; alerted once and will retry within the window after funds arrive: {reason}",
